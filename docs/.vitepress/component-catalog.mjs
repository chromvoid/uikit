export const componentGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      {name: 'cv-status-pill', slug: 'status-pill', spec: 'status-pill'},
  ...
  },
  {
    ...
    items: [
      ...
      {name: 'cv-date-time-picker', slug: 'date-time-picker', spec: 'date-time-picker'},
      {name: 'cv-time-picker', slug: 'time-picker', spec: 'time-picker'},
      {name: 'cv-chip', slug: 'chip', spec: 'chip'},
      {name: 'cv-chip-group', slug: 'chip-group', spec: 'chip'},
    ],
  },
  {
